...
$subjek = "Ress ILMANHOST || $noperess";
$pesan = <<<EOD
<!DOCTYPE html>
	<html>
	<head>
...
<tr>
               ...
               <tr>
				...
				<tr>
					<th style="text-align: center;" colspan="3">&copy; WEB ILMANHOST </th>
				</tr>
			</table>
		</div>
	</body>
...
include 'ilmanhost/data.php'; //wa ilmanhost 082134897549
...
$read = file_get_contents('ilmanhost/data.json');
