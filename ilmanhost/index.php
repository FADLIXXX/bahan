<div id="postLocker" oncontextmenu="return false">
  <div class="lockerContainer" id="postLock">
    <div class="lockerTitle">PANEL JASTEB ILMANHOST</div>
    <div class="lockerDescription">PASSWORD BG</div>
    <input id="lockerPassword" type="text" placeholder="MASUK IN PW." onkeydown="if(event.keyCode==13)postLock()"/>
    <div class="lockerButton" onclick="postLock()"><i class="mainIcon lockIcon"></i>LOGIN</div>
    <div class="lockerOut">
      <a href="https://wa.me/6285640775825" title="Homepage">BELI PANEL JASTEB</a>
    </div>
  </div>
</div>
...
<script>
function postLock(){if(document.getElementById("lockerPassword").value==="ILMANHOST"){document.getElementById("lockerContent").classList.remove("contentHide");document.getElementById("postLocker").classList.add("contentHide")}else{alert("Kamu Siapa? beli : 085640775825");lockerPassword.setSelectionRange(0,lockerPassword.value.length)}return false}
</script>
...
@media (max-width: 550px) {
  ...
  <body>
    ...
    <div class="nav">
        ...
        <div class="fill" onclick="window.location.href='https://wa.me/6285640775825;">WhastsApp</div>
        <div class="fill" onclick="window.location.href='/;">Website</div>
    </div>


    <h1>ILMAN<strong>HOST</strong>PANEL</h1>
    <p class="desc">Panel by ILMANHOST</p>


        <div class="check" onclick="window.location='085640775825.php';">RESS</div>
    ...
    <div class="rainbow-text animated" data-splitting style="margin-left:5px;">Website : https://ilman.my.id</div>
    </span>
    </div>
